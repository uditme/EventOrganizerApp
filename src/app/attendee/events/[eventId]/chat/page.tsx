...
export default function AttendeeEventChatPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center py-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600">Event Chat</p>
            </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {loadingMessages ? (
            ...
            messages.map((message) => (
              <div
                key={message._id}
                className={`flex ${message.type === 'announcement' ? 'justify-center' : 'justify-start'}`}
              >
      ...
      <div className="bg-blue-50 border-t border-blue-200 p-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center space-x-2">
            ...
            <h4 className="text-sm font-medium text-blue-900">Real-time Chat Coming Soon</h4>
          </div>
          <p className="text-sm text-blue-700 mt-1">
            This is a preview of the event chat interface. Real-time messaging functionality is currently under development.
          </p>
        </div>
      </div>
    </div>
